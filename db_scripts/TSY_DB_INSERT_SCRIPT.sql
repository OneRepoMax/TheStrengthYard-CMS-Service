...
-- -----------------------------------------------------
INSERT INTO `tsy_db`.`IndemnityForm` VALUES
...
(302, "Search Engine, Friend's Recommendation, Walking Pass, Google Maps, Facebook Adverts, Google Adverts, Other", "Heart Problems, Pain in Chest when exercising/not exercising, Low Blood Pressure/High Blood Pressure, Any breathing difficulties or asthma, Diabetes, Fainting spells, Joint problems, Epilepsy, Currently on medication, Significant illness/Operations, None, Other","I had a heart operation back in 2008 and my knees are very weak. I am also on medication for my heart. I also have fainting spells once in a while.", 1, 1, 100);
...
(1, 'Monthly', "Public", 250, 'Progressive Strength Class Membership (Standard)', "Get access to our Progressive Strength Class and enjoy a well-rounded fitness experience. This membership includes monthly sessions to help you build strength and improve your overall fitness.", "https://tsy-admin-bucket.s3.ap-southeast-1.amazonaws.com/AEC1ADBF-6A40-4150-BC9E-169496C3E737-1022-0000175AF0BEA8F0.JPG", "P-3Y5474454G139761KMUA2YTA", 70, TRUE),
...
(3, 'Monthly', "Public", 200, 'Progressive Strength Class Membership (Student)',"Designed exclusively for students, this membership offers access to our Progressive Strength Class. Stay fit while you pursue your education with our monthly class sessions.", "https://tsy-admin-bucket.s3.ap-southeast-1.amazonaws.com/AEC1ADBF-6A40-4150-BC9E-169496C3E737-1022-0000175AF0BEA8F0.JPG", "P-2CG607110D459422MMUECUIA", 70, TRUE),
...
(5002, 'Saturday', '2023-10-07 07:00:00', '2023-10-07 08:00:00', 60, 0, 300);

-- -----------------------------------------------------
-- Inserting Sample Data into Table `tsy_db`.`Points`
-- -----------------------------------------------------
INSERT INTO `Points` VALUES 
(6000, 2, '2023-09-20', '2023-10-20', 11, 'Paid'),
